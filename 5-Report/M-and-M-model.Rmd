...
Details of how each of the matrices were form are in the Appendix A, but a summary of the range of each parameter is provide below.  
...
parameterization <- data.frame(Parameter, Unit)
...
Within a year, waterhemp population projection from sub-annual period $k$ to $k+1$ was reflected by the changes in number of seeds and plants and calculated as follow [Chapters 2, 3 and 4, @caswellMatrixPopulationModels2001].  
$$N_{h+1} = B_h*N_h$$  
where,  
