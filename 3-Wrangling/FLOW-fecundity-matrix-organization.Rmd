...
The calculation of fecundity (F) from 2019 aboveground mass (X) data is from [@nguyenImpactCroppingSystem2022], in which each crop identity crossed with corn weed management treatment is of the form $ F = aX + b$. Variance of mean fecundity was the summation of variance of intercept and slope, because they are fixed
