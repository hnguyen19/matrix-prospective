...
table(female_19$Plot, female_19$Crop_ID)
...
# table(female_19_est$Plot, female_19_est$Crop_ID) returns no Plot number for soybeans because none of them survived

## check if any NA
female_19_est_NA <- female_19_est %>% extract(!complete.cases(.), )

## make a blank data frame with 2019 soybean plot designation for placeholders
female_19_soy_blank <- expand.grid()
...
female_19_est_quantile_summ_NA <- female_19_est_quantile_summ %>%
