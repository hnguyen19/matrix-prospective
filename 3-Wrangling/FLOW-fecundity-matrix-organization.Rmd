...
fecundity_var_19_list  <-  lapply(split(female_19_est_quantile_summ_expand, female_19_est_quantile_summ_expand$matrix_id),
       function(x) diag(x$var_Seed_cohort,6))

# saveRDS(fecundity_var_19_list, file="../2-Data/Clean/fecundity-var-19-cohort.RData")
