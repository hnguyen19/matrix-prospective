...
# the first 2 columns and 2 rows are all zeros because this var matrix is a 6x6
var_fecundity_19_list <- lapply(split(female_19_est_cohort_sorted, female_19_est_cohort_sorted$matrix_id),
       function(x) rbind(cbind(diag(0,2),matrix(0,nrow=2,ncol=6)),
