...
The variance of off-season seed viability is calculated with $Var(g(x)) = [g'(X)]^2 \sigma^2_X$

following linearization of exponential function on page 29/125 <https://pdixon.stat.iastate.edu/stat511/notes/part%205.pdf>, and
