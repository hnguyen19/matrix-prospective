...
The variance of off-season seed viability is calculated with $Var(g(Y)) = [g'(Y)]^2 \sigma^2_Y$, so $Var[ln(Y)] = \frac{1}{Y^2}\sigma^2_Y$

Using the delta method to find Var(Y) from Var(ln(Y)) (Var(Y) here is the variance of Variance)
