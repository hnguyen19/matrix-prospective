...
With a uniform germination rate in all the crop identity crossed with corn weed management at 20%, the remaining seedbank density in the 0 - 2 cm soil stratum is calculated using the following equation: 
...
```{r general-emerge-assign, echo=FALSE}
...
female_emerge_prop_20_total %>%
  ...
  flextable() %>%
    set_caption("Estimated seedling emergence proportion with respect to the top 0 - 2 cm soil stratum using 2019 stratified soil seedbank densities and 2020 seedling emergence densities and adjusted seedling emergence proportions for use in the modelling excercises.") %>%
  set_header_labels(values = list(Crop_ID = "Crop ID",
                Corn_weed_management = "Corn weed management",
               total_emerge_from_top_estimated_prop = "0 - 2 cm",
               total_emerge_from_top_assigned = "0 - 2 cm",
