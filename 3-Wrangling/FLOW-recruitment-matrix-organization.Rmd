...
The resistance profile of waterhemp at our experiment site was undetermined, but the raw estimation of seedling emergence with respect to the top 0 - 2 cm soil seedbank density seems unrealistically low (Table \@ref(tab:emerge-prop-tab). The cohort-specific emergence rates ($e_1$ through $e_6$) were adjusted from the raw data ($\frac{p_k}{N_{B_{st,11}}}$ with $k = \{1,...,6\}$) to reflect 3% emergence success rate (equivalent to $E = 0.006 * N_{B_{st,11}}$) in crop environments that received herbicides (C2, S2, C3, S3, C4, and S4) and 50% emergence success rate (equivalent to $E = 0.1 * N_{B_{st,11}}$).  
