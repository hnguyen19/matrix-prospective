...
and set a uniform germination rate in all the crop identity crossed with corn weed management at 20%. The remaining seedbank density in the 0 - 2 cm soil stratum is calculated using the following equation: 
...
female_emerge_prop_20_total <- female_emerge_prop_20 %>%
  ...
  mutate(cohort_1_share = `1`/total_emerge_from_top_estimated,
         cohort_2_share = `2`/total_emerge_from_top_estimated,
         cohort_3_share = `3`/total_emerge_from_top_estimated,
         cohort_4_share = `4`/total_emerge_from_top_estimated,
         cohort_5_share = `5`/total_emerge_from_top_estimated,
         cohort_6_share = `6`/total_emerge_from_top_estimated) %>%
...
female_emerge_prop_20_total %>%
  select(Crop_ID, Corn_weed_management, 
         total_emerge_from_top_estimated,
         total_emerge_from_top_assigned) %>%
  flextable()
