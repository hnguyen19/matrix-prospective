...
after_oat <- seed_O %*% sv_O %*% em_O %*% prt_O %*%  ow_O %*%  poh_O %*% after_soy # oat phase dynamics

after_alfalfa <- seed_A %*% sv_A %*% em_A %*% prt_A %*%  ow_A %*%  poh_A %*% after_oat # soybean phase dynamics
