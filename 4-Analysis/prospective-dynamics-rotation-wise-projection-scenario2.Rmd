...
Using 2018 fecundity rates, waterhemp populations in all crop identity halved annually (Figures \@ref(fig:scenario2-lambda-annualized) and \@ref(fig:phase-lambda)). 
...
```{r phase-lambda, echo=FALSE, fig.cap= "Waterhemp population growth rate in each crop phase using 2018 fecundity rate."}
