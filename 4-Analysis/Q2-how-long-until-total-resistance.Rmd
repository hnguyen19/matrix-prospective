...
The available models for herbicide resistance profile estimation do not accommodate a population with depth-structured seedbank and cohort-structured plant [], so a generalized equation, similar to equation 7 in @ is used.  
...
As the projection model only keeps track of plump, viable seeds, it is unnecessary to subtract the non-viable seeds in this equation. As close to 90% of the mature seeds germinated after either 30 C or -20 C postharvest treatment [Figure 3B, ], we feel that it is reasonable to assume 100% viability of the new, plump seeds.  

The simulation started with a population of 10000 seeds in the 0 -  2 cm soil stratum and 0 seeds in the 2 - 20 cm soil stratum, in which 5% of the seeds are resistant to one active ingredient. The following assumptions are made  
...
For simplicity, we assume that the heterozygotic plants (SR) are killed by the active ingredient of interest (the S allele is totally dominant of the R allele). In reality, the survival rate of SR can be higher than SS [Chapter 8, ].
