...
Within the same calendar year, seedling densities were lower in the warm-season crops than in the cool-season crops (Table \@ref(tab:seedlings-density-19-20)).

The first cohort of waterhemp that emerged in different cohorts were significantly different crop environments (Table \@ref(tab:Julian-19-20-tab)). Waterhemp emergence was delayed in alfalfa crop environment as compared to corn and soybean environments. Waterhemp emergence was nine to sixteen days earlier in oat than that in alfalfa.    
...
```{r, echo=FALSE, fig.cap = "Diagnosis plots for the effects of crop identity and corn weed management on the seedling densities in 2019 (A) and 2020 (B)"}
list(emerge_cohort_19_gls, emerge_cohort_20_gls) %>%
   lapply(resid_panel, nrow = 4) %>% 
  wrap_plots() +
  plot_annotation(tag_levels = "A")
