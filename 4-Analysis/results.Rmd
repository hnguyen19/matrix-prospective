...
```{r, child = "Q2-mature-plant-density-allowance-rot.Rmd"}
```
...
```{r top-bot-strata-diag, echo=FALSE, fig.cap = "Diagnosis plots for the effects of crop identity and crop weed managennt on the seedbank densities at the top (A) and bottom (B) soil strata"}
...
```{r top-bot-cohort1-diag, echo=FALSE, fig.cap = "Diagnosis plots for the effects of crop identity and corn weed management on the seedbank densities at the top (A) and bottom (B) soil strata"}
...
The code for seed production thresholds simulation is available at <https://github.com/hnguyen19/matrix-prospective/blob/master/4-Analysis/Q1-seed-production-allowance-rot.Rmd>

```{r, child= "Q1-fecund-prep.Rmd"}
```


The code for mature plant density thresholds simulation is available at <https://github.com/hnguyen19/matrix-prospective/blob/master/4-Analysis/Q2-mature-density-allowance-rot.Rmd>
