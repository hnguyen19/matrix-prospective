...
```{r elasticity-3yr}
# lambda at scenario1_rotation_wise_lambda 
lambda_3yr_conv <- scenario1_rotation_wise_lambda$scenario1_rotation_wise_3yr_conv$lambda1 

lambda_3yr_low <- scenario1_rotation_wise_lambda$scenario1_rotation_wise_3yr_low$lambda1 
...
Variance of annualized population growth rate is calculated with $Var(X^n) = E(X^{2n}) - E(X^n)^2$
