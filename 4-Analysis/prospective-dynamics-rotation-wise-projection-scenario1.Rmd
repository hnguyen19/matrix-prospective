...
```{r S-B-spring-tillage-contribution-2yr, fig.cap="Contribution of each entry element in the spring tillage sub-annual matrix to lambda."}
...
```{r S-B-emerge-contribution-2yr, fig.cap="Contribution of each entry element in the emergence sub-annual matrix to lambda."}
## subletting removes names
...
```{r S-B-summer-survival-contribution-2yr, fig.cap="Contribution of each entry element in the emergence sub-annual matrix to lambda."}
## subletting removes names
...
```{r S-B-post-harvest-contribution-2yr, fig.cap="Contribution of each entry element in the post harvest tillage sub-annual matrix to lambda."}
...
```{r S-B-overwinter-contribution-2yr, fig.cap="Contribution of each entry element in the overwinter sub-annual matrix to lambda."}
## subletting removes names
...
var_elements_2yr_lambda <- tibble::lst(S_B_contribution_2yr_first_transposed_each,
                               var_scenario1_projection_2yr_conv_unlist,
                               S_B_contribution_2yr_first)

## Multiply t(S_B), V, and S_B 

var_elements_2yr_lambda  <- Map(\(x, y, z) Reduce(`%*%`,
                      list(x, y, z)),
