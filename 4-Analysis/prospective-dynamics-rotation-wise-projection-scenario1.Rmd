...
min(scenario1_mean_fecundity_2019[["C4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["C4_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["C3_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["C3_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["C2_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["C2_low"]][1,3:8]) #0.5787379 seeds/plant

max(scenario1_mean_fecundity_2019[["C4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["C4_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["C3_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["C3_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["C2_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["C2_low"]][1,3:8]) # 2029.261 seeds/plant



min(scenario1_mean_fecundity_2019[["S4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["S4_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["S3_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["S3_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["S2_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["S2_low"]][1,3:8]) #0.1994956 seeds/plant

max(scenario1_mean_fecundity_2019[["S4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["S4_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["S3_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["S3_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["S2_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["S2_low"]][1,3:8]) #49.43887 seeds/plant


min(scenario1_mean_fecundity_2019[["O4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["O4_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["O3_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["O3_low"]][1,3:8]) #0.7044676 seeds/plant

max(scenario1_mean_fecundity_2019[["O4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["O4_low"]][1,3:8],
    scenario1_mean_fecundity_2019[["O3_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["O3_low"]][1,3:8]) # 554.8986 seeds/plant

min(scenario1_mean_fecundity_2019[["A4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["A4_low"]][1,3:8]) #0.5167489 seeds/plant

max(scenario1_mean_fecundity_2019[["A4_conv"]][1,3:8],
    scenario1_mean_fecundity_2019[["A4_low"]][1,3:8]) #17.34985 seeds/plant
...
```{r scenario1-merge-rotation-phase-lambda, echo=FALSE}
scenario1_annualized_lambda_df_condensed <- scenario1_annualized_lambda_df_long %>%
...
scenario1_phase_lambda_wide <- scenario1_phase_lambda %>%
  ...
  dplyr::mutate(phase_order = ifelse(str_detect(Crop_ID, "C"), 1,
  ...
  tidyr::pivot_wider(names_from = Phase, values_from = phase_lambda_r)


scenario1_annualized_lambda_df_condensed %>%
  left_join(scenario1_phase_lambda_wide,by = c("Rotation", "Corn_weed_management") ) %>%
  flextable() %>%
...
#  geom_text(data = lambda_label, aes(label = label), size = 2.5, x = 4, y = 13) +
      geom_text(aes(x = Year, 
                  y = 14,  #leave space between bar and label
                  label = Sequence), 
              size = 2) +
  guides(colour = "none")
# one layered panel name <https://stackoverflow.com/questions/45699411/facet-label-merging-into-a-single-row-ggplot2>
...
```{r scenario1-E-B-output-supp, include=FALSE}
#View(scenario1_E_B_recombine_ranked_value)
# write.csv(scenario1_E_B_recombine_ranked_value[,1:8], "../5-Report/scenario1-elasticities.csv", row.names = FALSE) # exclude the ln-transformed columns 
```
