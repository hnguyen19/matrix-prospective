...
## Emergence 
scenario1_mean_emergence <- readRDS("../2-Data/Clean/adjusted-mean-emergence-prop.RData")
...
#  theme(axis.text.x = element_text(angle = 90)) +
  ...
  ylim(0,16) +
  geom_text(data = lambda_label, aes(label = label), size = 3.5, x = 4, y = 13) +
